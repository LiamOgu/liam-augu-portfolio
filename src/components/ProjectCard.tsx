          ...
          <div className="flex gap-2">
            {project.githubUrl && (
              <span
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-xs text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600 rounded hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer"
              >
                <svg
            ...
            {project.liveUrl && (
              <span
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-xs text-white dark:text-gray-900 bg-gray-900 dark:bg-gray-100 rounded hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors cursor-pointer"
              >
                <svg
                  className="w-3.5 h-3.5"
                  fill="none"
